...
Ce projet de recherche a été rendu possible grâce aux financements de *Canadian Healthy Oceans Network* II, le Conseil de Recherches en Sciences Caturelles et en Génie du Canada, l'Institut Nordique de Recherche en Environnement et en Santé au Travail (représentant Port de Sept-Îles et Ville de Sept-Îles) et l'Institut des Sciences de la Mer. Les contributions financières de Québec-Océan, l'unité mixte internationale Takuvik, le Réseau Québec-Maritime et l'Institut France-Québec Maritime ont permis la participation à plusieurs congrès et deux stages de recherche (à *University of Victoria* et la station biologique de Dinard) contribuant à l'acquisition de nouvelles compétences, le développement d'un réseau de recherche et le rayonnement des travaux réalisés durant cette thèse.

Cette thèse est divisée en quatres sections principales : une introduction présentant les différents concepts et principes utilisés tout au long de la thèse, le corps principal contenant trois chapitres expliquant les analyses effectuées et interprétant les résultats obtenus, une conclusion générale intégrant les différentes conclusions et présentant différentes perspectives, ainsi qu'une section d'annexes. Cette dernière comprend un article de perspective, réalisé lors du programme de mentorat de la 4^eme^ *World Conference on Marine Biodiversity* traitant de la contribution des évaluations environnementales holistiques pour atteindre les *Aichi Biodiversity Targets*, ainsi qu'une illustration sous forme de bande-dessinée, présentée lors d'un évènement de vulgarisation pour illustrer les activités effectuées lors du doctorat.
