...
% ----------------------------------------------------
% Ajouts C. Rigaud :
\usepackage[linktocpage=true,linkcolor=black,citecolor=black,colorlinks=true,urlcolor=black,pagebackref]{hyperref}
...
\Titre{DESCRIPTION DE L'INFLUENCE HUMAINE SUR LES ÉCOSYSTÈMES BENTHIQUES D'UNE ZONE INDUSTRIALO-PORTUAIRE SUBARCTIQUE}
\SousTitre{APPLICATION D'INDICATEURS DE STATUT ÉCOLOGIQUE ET PRÉDICTION DE LA STRUCTURE DES COMMUNAUTÉS}
% Mettre en majuscule!!
\Auteur{Elliot Dreujou}
...
\begin{singlespace}
  ...
  \bibliography{references.bib} % Ici mettre le nom de la biblio, ici mylib.bib
\end{singlespace}
