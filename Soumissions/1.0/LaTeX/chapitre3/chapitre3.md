...
Describing exposure from multiple human activities on coastal benthic ecosystems at the local scale

# Authors

Elliot Dreujou, Rémi M. Daigle, David Beauchesne, Julie Carrière, Philippe Archambault
...
Slow sinking & \textless 4 µm & clay, dissolved organic matter, small bacteria, viruses, chemical components, proteins \\
Medium sinking & 4 µm - 2 mm & sand, silt, small particulate organic matter, large bacteria, small dead organisms (phytoplankton, zooplankton) \\
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\columnwidth]{figures/C3_Fig2.png}
